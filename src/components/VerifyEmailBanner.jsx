...
const VerfiyEmailBanner = () => {
  ...
  return (
    <Styles.Banner style={{ display: showBanner && "none" }}>
      <Styles.Aside>
        <Image
          src="https://s3.us-east-2.amazonaws.com/dailykit.org/onboarding/images/MailVerification.png"
          width="70"
          height="70"
          alt="verifymail"
        />
      ...
      <Styles.Main>
        <section>
          ...
          <span
            ...
            onClick={() => setonShowBanner(true)}
          >
            ✖
          </span>
          <p>
            We need to verify your Email Address. Please check your inbox for a
            messsage from us. You’ll find confirmation link inside.
          </p>
        </section>
        <section>
